...
<head>
    ...
    <style>
        ...
        .card { background:#fff; max-width:420px; width:100%; border-radius:8px; padding:1.5rem 2rem; box-shadow:0 10px 25px rgba(15,23,42,0.10); }
...
<div class="auth-wrapper">
    <div class="card">
        ...
        <p class="subtitle">Join TeamHub to collaborate with your team.</p>
